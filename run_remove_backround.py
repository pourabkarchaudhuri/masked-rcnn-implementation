...
LEVEL_DIR = os.getcwd()
MODEL_DIR = os.path.join(LEVEL_DIR, "logs")
INPUT_DIR = os.path.join(LEVEL_DIR, "dataset", "input")
OUTPUT_DIR = os.path.join(LEVEL_DIR, "dataset", "output")
...
if __name__ == "__main__":
    image = cv2.imread(os.path.join(INPUT_DIR, "sample.jpg"))
    ...
    cv2.imwrite(os.path.join(OUTPUT_DIR, "temp.png"), image)

    image = PIL.Image.open(os.path.join(OUTPUT_DIR, "temp.png"))
